...
public class WorktypeController {
    ...
    @ApiOperation(value = "增加工种",notes = "测试数据:{\"worktype_name\":\"电工\",\"content\":\"主要负责工地电力工作\",\"section_id\":1,\"station_id\":1,\"department_id\":1,\"remark\":\"电力维护安全很重要\"}")
    ...
    @ApiOperation(value = "下拉框查询站点信息",notes = "测试数据:{\"section_id\":1,\"station_id\":1,\"department_id\":1}")
