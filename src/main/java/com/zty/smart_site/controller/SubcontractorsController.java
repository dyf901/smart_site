...
public class SubcontractorsController {
    ...
    @ApiOperation(value = "删除分包单位信息",notes = "测试数据:")
    ...
    @ApiOperation(value = "修改分包单位信息",notes = "测试数据:")
    ...
    @ApiOperation(value = "分页模糊查询分包单位信息",notes = "测试数据:")
    ...
    @ApiOperation(value = "下拉框查询分包单位信息",notes = "测试数据:")
